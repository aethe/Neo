...
// inline std::string mat3::as_string() const {
//     return "[" + v1.as_string() + ", " + v2.as_string() + ", " + v3.as_string() + "]";
// }
...
inline mat3 mat3::lerp(const mat3& other, float t) const {
    return mat3(v1.lerp(other.v1, t), v2.lerp(other.v2, t), v3.lerp(other.v3, t));
}
